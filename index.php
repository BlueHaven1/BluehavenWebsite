...
<body>
                    ...
                    <div class="products-track">
                        ...
                        <div class="product-slide">
                            <div class="product-card">
                                ...
                                <div class="product-info">
                                    ...
                                    <p class="product-description">A comprehensive collection of high-quality scripts to enhance your server functionality.</p>
                                    <a href="product.php?id=1" class="btn btn-primary">View Item</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="product-slide">
                            <div class="product-card">
                                ...
                                <div class="product-info">
                                    <div class="product-title">
                                        <h3>Advanced Vehicle Pack</h3>
                                        <span class="product-price subscription-price">$19.99/month</span>
                                    </div>
                                    <div class="product-badge">
                                        <span class="subscription-badge">Subscription</span>
                                    </div>
                                    <p class="product-description">Get access to our premium vehicle liveries with monthly updates and new additions.</p>
                                    <a href="product.php?id=2" class="btn btn-primary">View Item</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="product-slide">
                            <div class="product-card">
                                ...
                                <div class="product-info">
                                    <div class="product-title">
                                        <h3>Custom EUP Package</h3>
                                        <span class="product-price">$34.99</span>
                                    </div>
                                    <p class="product-description">High-quality custom uniforms and clothing for your server's emergency services.</p>
                                    <a href="product.php?id=3" class="btn btn-primary">View Item</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <footer>
        <div class="container">
            ...
            <div class="copyright">
                <p>&copy; 2023 BlueHaven. All rights reserved.</p>
            </div>
        </div>
    </footer>
    <!-- Slider JavaScript -->
